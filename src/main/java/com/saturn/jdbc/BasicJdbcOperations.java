...
public interface BasicJdbcOperations {
     ...
     * @throws DataAccessException 执行时出错
     */
    public <T> List<T> queryForList(final String sql, final Class<T> clazz, final Object... objs) throws DataAccessException;
     ...
     * @throws DataAccessException 执行时出错
     */
    public <T> List<T> queryForList(final String sql, final Class<T> clazz, final Collection<Object> args) throws DataAccessException;
     ...
     */
    public <T> T queryForObject(final String sql, Class<T> clazz, Object... objs) throws DataAccessException;
     ...
     * @throws DataAccessException 执行查询时出错
     */
    public <T> T queryForObject(final String sql, Class<T> clazz, final Collection<Object> args) throws DataAccessException;
